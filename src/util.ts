...
function supportWebp() {
  ...
  checkWebpFeature("lossy", (isSupported: boolean) => {
    support = isSupported;
  });
  checkWebpFeature("lossless", (isSupported: boolean) => {
    support = isSupported;
  });
  checkWebpFeature("alpha", (isSupported: boolean) => {
    support = isSupported;
  });
  checkWebpFeature("animation", (isSupported: boolean) => {
    support = isSupported;
  });
